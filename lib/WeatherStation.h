...
private:
    ...
    // These pointers are for composition with the register classes i.e (MeasuringValues = input regs)
...
public:
    ...
    std::shared_ptr<MeasuringValues> readMeasuringValues(); // Return the composition class pointer to access the functions
